...
CREATE TABLE `history` (
  ...
  `shareprice` decimal(65,4) unsigned NOT NULL DEFAULT '0.0000',
...
INSERT INTO `history` VALUES (4,9,'GOOGL','bought',10,787.2000,'2016-09-13 19:02:33'),(5,9,'AMZN','bought',15,760.5550,'2016-09-13 19:02:43'),(6,9,'AMZN','bought',5,760.7250,'2016-09-13 19:02:58'),(7,9,'TSLA','bought',20,194.5400,'2016-09-13 19:10:41'),(8,9,'AMZN','sold',65,761.0100,'2016-09-14 03:11:32');
...
CREATE TABLE `portfolios` (
  ...
  KEY `user_id` (`user_id`,`symbol`,`shares`)
...
INSERT INTO `portfolios` VALUES (3,9,'FREEF',15),(7,9,'GOOGL',12),(11,9,'TSLA',20);
...
-- Dump completed on 2016-09-14  3:52:21
