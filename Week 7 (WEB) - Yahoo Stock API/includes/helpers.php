<?php
     ...
     * to browser.
     */
    function dump() //this function is for diagnostics purposes but remove when submitting work
    {
     ...
     */
    function lookup($symbol) //queries Yahoo Finance for stocks prices and more
    {
     ...
     */
    function render($view, $values = []) //found the render function
    {
