...
app.controller('SogoController', function ($scope, $http, $location, $route, $routeParams, friendBoard) {
    ...
    document.getElementsByTagName('script')[2].src = 'http://sogos.azurewebsites.net/FrontEnd/Scripts/main.js?n=' + jsVersion;
    document.getElementsByTagName('script')[8].src = 'http://sogos.azurewebsites.net/FrontEnd/Scripts/JS/App.js?n=' + jsVersion;
    document.getElementsByTagName('script')[13].src = 'http://sogos.azurewebsites.net/FrontEnd/Scripts/Controllers/SogoController.js?n=' + jsVersion;
